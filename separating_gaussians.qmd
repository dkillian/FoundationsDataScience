...
For this dataset, $\pi_f =$ `r round(prior_f, 3)` and $\pi_m =$ `r round(prior_m, 3)`. These reflect the sample composition and serve as **prior probabilities** before observing any height.
